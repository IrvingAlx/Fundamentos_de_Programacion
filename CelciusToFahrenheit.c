...
int main(void){
 	...
 	mostrarInstrucciones("Irving Alejandro", "Programa que muestra la duma de los numeros pares \n\t\t y la cantidad de impares que tiene el numero ingresado");
	...
	if (x == 1) {
		...
		printf("\n\n\tIngrese los grados Celsius que desea convertir en Faherenheit\n\t");
 		scanf("%f",&centi);	
