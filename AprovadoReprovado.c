...
int main(void) {
  ...
  mostrarInstrucciones(
      "Irving Alejandro",
      "Programa que muestra las materias \n\t\t reprobadas de 3 alumnos");
  limpiarEntradaDatos();
...
void calificacionAprobadas(void) {
  ...
  printf("\n\n\tAlumno 1 usted tiene %d materias aprobadas y %d materias "
         "reprobadas\n\t",
         aprobadas[0], reprobadas[0]);
  printf("\n\n\tAlumno 2 usted tiene %d materias aprobadas y %d materias "
         "reprobadas\n\t",
         aprobadas[1], reprobadas[1]);
  printf("\n\n\tAlumno 3 usted tiene %d materias aprobadas y %d materias "
         "reprobadas\n\t",
