...
int main(void) {
  ...
  mostrarInstrucciones("Irving Alejandro",
                       "Programa que muestra la duma de los numeros pares y la "
                       "cantidad de impares que tiene el numero ingresado");

  printf("Ingrese un numero entero y positivo que se encuentre entre el 0 y "
         "99999888: ");
  scanf("%f", &f);
